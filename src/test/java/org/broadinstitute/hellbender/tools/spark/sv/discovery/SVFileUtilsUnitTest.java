...
public class SVFileUtilsUnitTest extends GATKBaseTest {
    ...
    public void testWriteSAMRecords() {
        ...
        final ReadsDataSource gatkReads = new ReadsDataSource(new GATKPathSpecifier(inputBam));
        ...
        final ReadsDataSource bamOut = new ReadsDataSource(new GATKPathSpecifier(outputPath));
        ...
        final ReadsDataSource samOut = new ReadsDataSource(new GATKPathSpecifier(outputPath));
