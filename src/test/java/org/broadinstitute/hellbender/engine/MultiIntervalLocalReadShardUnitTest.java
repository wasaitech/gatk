...
public class MultiIntervalLocalReadShardUnitTest extends GATKBaseTest {
    ...
    public Object[][] shardBoundsTestData() {
        final ReadsDataSource readsSource = new ReadsDataSource(new GATKPathSpecifier(publicTestDir + "org/broadinstitute/hellbender/engine/reads_data_source_test1.bam"));
