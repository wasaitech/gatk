...
public class PipelineSupportIntegrationTest extends GATKBaseTest {
    ...
    public void testPipeForPicardTools() {
        ...
        try (ReadsDataSource inputReads = new ReadsDataSource(new GATKPathSpecifier(INPUT_BAM));
             ReadsDataSource outputReads = new ReadsDataSource(IOUtils.toGATKPathSpecifier(output))) {
