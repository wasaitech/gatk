...
public final class ReadsContextUnitTest extends GATKBaseTest {
    ...
    public Object[][] getEmptyReadsContextData() {
        ...
        return new Object[][] {
                ...
                { new ReadsContext(new ReadsDataSource(new GATKPathSpecifier(publicTestDir + "org/broadinstitute/hellbender/engine/reads_data_source_test1.bam")), null) }
        };
    }
    ...
    public Object[][] getValidReadsContextData() {
        ...
        return new Object[][]{
                {new ReadsContext(
                        new ReadsDataSource(new GATKPathSpecifier(publicTestDir + "org/broadinstitute/hellbender/engine/reads_data_source_test1.bam")),
    ...
    public void testIteratorOverDifferentInterval() {
        final ReadsDataSource readsDataSource = new ReadsDataSource(new GATKPathSpecifier(publicTestDir + "org/broadinstitute/hellbender/engine/reads_data_source_test1.bam"));
